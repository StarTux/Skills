...
public enum TalentType implements ComponentLike {
    // Mining
    MINE_MAGNET(MINING, null, 1, Vec2i.of(5, 4)),

    STRIP_MINING(MINING, null, 1, Vec2i.of(6, 3)),
    DEEP_MINING(MINING, STRIP_MINING, 2, Vec2i.of(6, 2)),
    VEIN_MINING(MINING, STRIP_MINING, 1, Vec2i.of(7, 3)),
    VEIN_METALS(MINING, VEIN_MINING, 2, Vec2i.of(8, 3)),
    VEIN_GEMS(MINING, VEIN_MINING, 2, Vec2i.of(8, 4)),
    RUBY(MINING, VEIN_GEMS, 2, Vec2i.of(8, 5)),

    MINER_SIGHT(MINING, null, 1, Vec2i.of(4, 3)),

    SUPER_VISION(MINING, MINER_SIGHT, 3, Vec2i.of(4, 2)),
    NETHER_VISION(MINING, SUPER_VISION, 4, Vec2i.of(4, 1)),
    DEEP_VISION(MINING, NETHER_VISION, 5, Vec2i.of(3, 1)),

    ORE_ALERT(MINING, MINER_SIGHT, 3, Vec2i.of(3, 3)),
    EMERALD_ALERT(MINING, ORE_ALERT, 4, Vec2i.of(2, 3)),
    DEBRIS_ALERT(MINING, EMERALD_ALERT, 5, Vec2i.of(1, 3)),

    SILK_STRIP(MINING, ORE_ALERT, 2, Vec2i.of(3, 4)),
    SILK_MULTI(MINING, SILK_STRIP, 3, Vec2i.of(3, 5)),
    ...
    ARCHER_ZONE(ARCHERY, null, 1, Vec2i.of(6, 3)),
    ARCHER_ZONE_DEATH(ARCHERY, ARCHER_ZONE, 1, Vec2i.of(7, 3)),
    ARROW_SWIFTNESS(ARCHERY, ARCHER_ZONE_DEATH, 2, Vec2i.of(8, 3)),
    ARROW_DAMAGE(ARCHERY, ARROW_SWIFTNESS, 3, Vec2i.of(8, 2)), // up
    BONUS_ARROW(ARCHERY, ARROW_DAMAGE, 4, Vec2i.of(8, 1)),
    ARROW_VELOCITY(ARCHERY, BONUS_ARROW, 5, Vec2i.of(7, 1)),
    // Left: Crossbow AoE (15/15)
    XBOW_INFINITY(ARCHERY, null, 1, Vec2i.of(4, 3)),
    XBOW_VOLLEY(ARCHERY, XBOW_INFINITY, 2, Vec2i.of(3, 3)),
    XBOW_FLAME(ARCHERY, XBOW_VOLLEY, 3, Vec2i.of(2, 3)),
    XBOW_PIERCE(ARCHERY, XBOW_FLAME, 4, Vec2i.of(2, 4)), // down
    XBOW_DUAL(ARCHERY, XBOW_PIERCE, 5, Vec2i.of(2, 5)),
    XBOW_HAIL(ARCHERY, XBOW_FLAME, 4, Vec2i.of(2, 2)), // up
    XBOW_LINGER(ARCHERY, XBOW_HAIL, 5, Vec2i.of(2, 1)),
    // Down: Tipped (8)
    TIPPED_INFINITY(ARCHERY, null, 2, Vec2i.of(5, 4)),
    SPECTRAL_INFINITY(ARCHERY, TIPPED_INFINITY, 2, Vec2i.of(5, 5)),
    GLOW_MARK(ARCHERY, SPECTRAL_INFINITY, 4, Vec2i.of(4, 5)),
    // Up: Utility (9)
    ARROW_MAGNET(ARCHERY, null, 1, Vec2i.of(5, 2)),
    INFINITY_MENDING(ARCHERY, ARROW_MAGNET, 3, Vec2i.of(5, 1)),
    INSTANT_HIT(ARCHERY, INFINITY_MENDING, 5, Vec2i.of(4, 1)),
    ;
